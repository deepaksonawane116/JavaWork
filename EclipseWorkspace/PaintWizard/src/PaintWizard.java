...
public class PaintWizard {
	public static void main(String[] args) {
		...
		m.bestPaintFor(paints, paintWastesLeast);
		m.bestPaintFor(paints, paintCostsLeast);
...
class Methods {
	...
	public PaintTypes bestPaintFor (ArrayList<PaintTypes> paints, PaintTypes compare)
	{
		for (PaintTypes i : paints) {
			if (i.getWastedPaint() < compare.getWastedPaint()) {
				compare = i;
			}
		}
		return compare;
